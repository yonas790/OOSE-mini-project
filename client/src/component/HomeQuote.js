        ...
        return ( 
            <div className="container">
                <div className="row">
                    ...
                    <Card.Body>
                      <Card.Title>Awarded to be Best Hospital in Ethiopia</Card.Title>
                      <Card.Text>
                        We are overwhelmed by the support our patients provide us and 
                        you made us the best in Ethiopia!
                      </Card.Text>
                    </Card.Body>
                  </Card>
                    </div>
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>
                        Researcher Dr. Nebiyat Bekele found a new cure for microbes
                        growing on skin.
                      </Card.Text>
                    </Card.Body>
                  </Card>
